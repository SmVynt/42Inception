...
const links = [
  { label: "Email", value: "smvynt@gmail.com", href: "mailto:smvynt@gmail.com", copyable: true },
  { label: "X", value: "@SmVynt", href: "https://x.com/SmVynt" },
  { label: "GitHub", value: "SmVynt", href: "https://github.com/SmVynt" },
  { label: "LinkedIn", value: "SmVynt", href: "https://www.linkedin.com/in/pavel-s-27317610b/" },
]
...
export function ContactSection() {
  ...
  return (
    <section id="my-links" className="py-8 pb-12 md:py-12 md:pb-16 relative">
        ...
        >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <span className="text-mono text-[#737373] text-xs md:text-sm">Links</span>
            </div>
          </div>
        </motion.div>
              ...
              >
                {link.copyable ? (
                  ...
                  >
                    ...
                    <ArrowRight className="w-4 h-4 text-[#525252] group-hover:text-[#fafafa] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-300 flex-shrink-0" />
                  </a>
                )}
              </motion.div>
            ))}
